...
# Memray Export Mode
#poetry run memray run --trace-python-allocators --output /app/yearn-exporter/memray/$BROWNIE_NETWORK/$@.bin --force /usr/local/bin/brownie run $@ --network $BROWNIE_NETWORK -r