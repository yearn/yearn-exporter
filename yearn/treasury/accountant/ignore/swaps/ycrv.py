...
def is_minting_ycrv(tx: TreasuryTx) -> bool:
    ...
    # wrapping wrappers
    # wrapper side
    elif tx._symbol in new_wrappers and tx.from_address.address == ZERO_ADDRESS:
        return True
    
    # yCRV side
    elif tx._symbol == "yCRV" and tx.to_address.address == ZAP:
        return True
    
    # unwrapping wrappers
    # wrapper side
    elif tx._symbol in new_wrappers and tx.to_address.address == ZAP:
        return True
    
    # yCRV side
    elif tx._symbol == "yCRV" and tx.from_address.address == ZAP:
        return True
